...
namespace FileSizeCounter.MicroMvvm
{
  ...
  public static class PropertySupport
  {
    ...
    public static string ExtractPropertyName<T>(Expression<Func<T>> propertyExpresssion)
    {
      ...
      {
        throw new ArgumentException(Resources.PropertySupport_Error_ExpressionIsNotMemberExpression,
          "propertyExpresssion");
      }
      ...
      if (property == null)
      {
        throw new ArgumentException(Resources.PropertySupport_Error_MemberExpressionNotAccessProperty,
          "propertyExpresssion");
      }
